...
Play begins with attempting, in turn, to roll a 6 to get a body. 
Next, a 1 gets a head. Subsequently, any dice roll will get one of the remaining parts, until no more are available - now the turn continues until a dice roll cannot get a valid part.
...
Close and start again when the game is over, or let the loser see how long it "would have taken" to catch up (as live games often go!)
...
It was written in plain Windows 95 code, in C, without the luxury of DirectX surfaces or a visual coding environment.
...
I would also document it a little better.

### New Beetle for web (25 years later - 2015)
